...
namespace Voxif.AutoSplitter {
    public class FontTextComponent : LiveSplit.UI.Components.InfoTextComponent {
        ...
        public override void PrepareDraw(LiveSplit.Model.LiveSplitState state, LayoutMode mode) {
